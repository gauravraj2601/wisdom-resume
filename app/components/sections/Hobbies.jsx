    ...
    return (
      ...
      <div id="accordion-collapse" data-accordion="collapse">
        ...
        <div id="accordion-collapse-body-1" className="hidden" aria-labelledby="accordion-collapse-heading-1">
          <div className="p-5 border border-b-0 border-gray-200 text-[#172c65] font-bold dark:border-gray-700 dark:bg-gray-900">
        ...
        <div id="accordion-collapse-body-2" className="hidden" aria-labelledby="accordion-collapse-heading-2">
          <div className="p-5  border border-gray-200 text-[#333a4d] font-bold dark:border-gray-700 dark:bg-gray-900">
            <p className="text-gray-500 dark:text-gray-400">
